 ...
 */
  ...
  resizeable : function setResizeable(element){
    ...
    ;(function makeDOM(){
      ...
      bottomResizeTagElement.style.height = borderBottomWidth >= 6? borderBottomWidth : 6 + "px"
      ...
      rightResizeTagElement.style.width = borderRightWidth >= 6? borderRightWidth : 6 + "px"
